...
INSERT INTO products (
  ...
  'ტრადიციული თურქული ყავა, მოთხოვნისამებრ შაქრით.', 'Geleneksel yöntemlerle cezvede pişirilmiş köz kokulu Türk kahvesi.', 'Traditional finely ground Turkish coffee brewed in a cezve.', 'Традиционный турецкий кофе, сваренный в джезве, подается со стаканом воды.',
